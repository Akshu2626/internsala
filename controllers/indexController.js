...
exports.readJobData = catchAsyncErrors(async (req, res, next) => {
    ...
    try {
        ...
        // Retrieve the job array from the student document
        const jobData = student.job; // Assuming the array name is 'job'
